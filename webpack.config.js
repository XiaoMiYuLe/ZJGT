...
module.exports = {
    ...
    plugins: [
        ...
        new HtmlWebpackPlugin({
            title: "This is the result", //生成的HTML模板的title，如果模板中有设置title的名字，则会忽略这里的设置 html页面这样写<%= htmlWebpackPlugin.options.title %>
            ...
            chunks: ['wp_header'], //引入的模块，这里指定的是entry中设置多个js时，在这里指定引入的js，如果不设置则默认全部引入
            chunksSortMode: "auto", //这个选项决定了 script（引入的模块） 标签的引用顺序。默认有四个选项，'none', 'auto', 'dependency', '{function}'。
            excludeChunks: "", //排除的模块,和chunks相反
